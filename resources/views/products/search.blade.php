        ...
        <div class="products-layout">
                ...
                <div class="filter-box">
                    ...
                    <div class="filter-group">
                        ...
                        @foreach($categories as $cat)
                            <label>
                                {{-- Link trực tiếp đến trang danh mục (products.category) --}}
            ...
            <div class="products-content">
                <div class="products-toolbar">
                    <div class="result-count">Tìm thấy {{ $products->total() }} sản phẩm</div>
                    <div class="toolbar-right">
                        <span>Sắp xếp theo:</span>
                        {{-- Form sắp xếp (cần giữ lại query string 'q') --}}
                        <select class="sort-select" onchange="window.location.href = '{{ route('products.search') }}?q={{ $keyword }}&sort=' + this.value">
                ...
                <div class="product-grid">
                    @forelse($products as $product)
                        ...
                        <div class="product-card">
                            ...
                            <div class="product-info">
                                ...
                                {{-- Nút thêm giỏ hàng (sử dụng AJAX từ main.js) --}}
                    ...
                    @empty
                        <p class="text-center" style="grid-column: 1 / -1;">Không tìm thấy sản phẩm nào khớp với từ khóa **"{{ $keyword }}"**.</p>
                    @endforelse
                </div>
                
                {{-- Pagination --}}
                <div class="pagination-wrapper">{{ $products->appends(['q' => $keyword])->links() }}</div>
            </div>
