            ...
            <form action="{{ route('orders.place') }}" method="POST" id="checkoutForm" class="checkout-layout">
                ...
                <div class="checkout-form">
                    ...
                    <div class="form-section">
                        ...
                        <div class="payment-methods">
                            ...
                            {{-- Thanh toán ZaloPay --}}
                            <label class="payment-option">
                                <input class="form-check-input" type="radio" name="phuong_thuc_tt" id="zalopay" value="ZALOPAY">
                                <div class="payment-content">
                                    <div class="payment-icon"><i class="fas fa-qrcode"></i></div>
                                    <div class="payment-info">
                                        <strong>ZaloPay</strong>
                                        <p>Thanh toán online qua ví ZaloPay</p>
                                    </div>
                                </div>
                            </label>
                            ...
                            <label class="payment-option">
                                <input class="form-check-input" type="radio" name="phuong_thuc_tt" id="bank" value="CHUYEN_KHOAN">
                                <div class="payment-content">
                    ...
                    <div class="form-section">
                        <label class="checkbox-wrapper">
                            {{-- Bạn có thể thêm input hidden cho việc xác nhận --}}
                ...
                <div class="order-summary">
                    ...
                    <div class="order-totals">
                        ...
                        <div class="total-row">
                            <span>Giảm giá:</span>
                            <span class="text-danger">0₫</span> {{-- Giả định chưa có logic giảm giá --}}
                        </div>
                        <div class="total-row">
