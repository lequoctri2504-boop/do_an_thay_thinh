...
<section class="dashboard-section active">
    <div class="section-header">
        ...
        <div class="header-actions">
            {{-- Nút thêm đơn hàng mới (tùy chọn) --}}
        </div>
    </div>
    ...
    <div class="dashboard-card">
        ...
        <div class="search-box" style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px;">
            <form action="{{ route('staff.orders') }}" method="GET" style="display: flex; gap: 15px; align-items: center;">
                ...
                @if(request()->filled('keyword') || ($trangThai ?? ''))
                    <a href="{{ route('staff.orders') }}" class="btn btn-secondary">Hủy lọc</a>
                @endif
            </form>
        </div>
                    ...
                    <tr>
                        ...
                        @php
                            $getSortUrl = function($column) use ($sortBy, $sortOrder) {
                                ...
                                return route('staff.orders', array_merge(request()->except(['sort_by', 'sort_order', 'page']), ['sort_by' => $column, 'sort_order' => $newOrder]));
                            };
                ...
                @forelse($orders as $order)
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('staff.orders.edit', $order->id) }}" class="btn btn-sm btn-primary" title="Chi tiết & Cập nhật">
        ...
        <div class="pagination-wrapper">
            {{-- Sử dụng template tùy chỉnh cho Admin/Staff --}}
